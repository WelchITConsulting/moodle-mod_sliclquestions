...
class mod_sliclquestions_mod_form extends moodleform_mod
{
    protected function definition()
    {
        ...
        $mform->addHelpButton('register', 'pupilregister', 'sliclquestions');
        $mform->disabledIf('register', 'questype', 'neq', SLICLQUESTIONS_PUPILASSESSMENT);
        $mform->addElement('editor', 'page', get_string('additionalinfo', 'sliclquestions'), null, sliclquestions_editor_options($this->context));
        $mform->addHelpButton('page', 'additionalinfo', 'sliclquestions');
