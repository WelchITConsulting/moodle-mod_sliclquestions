...
$string['pupilsassessed']                           = 'Total number of pupils assessed (registered)';
$string['pupilsboth']                               = 'Male and female pupils';
$string['pupilsfemale']                             = 'Female pupils';
$string['pupilsmale']                               = 'Male pupils';
$string['pupilregister']                            = 'Pupil register';
$string['pupilregister_help']                       = 'The register of pupils to be assessed using this questionnaire';
...
$string['send']                                     = 'Send';
$string['sendmessage']                              = 'Send message to selected users';
$string['sex']                                      = 'Sex';
...
//$string['sliclquestions:copysurveys']               = 'Copy template and private questionnaires';
//$string['sliclquestions:createpublic']              = 'Create public questionnaires';
//$string['sliclquestions:createtemplates']           = 'Create template questionnaires';
//$string['sliclquestions:deleteresponses']           = 'Delete any response';
//$string['sliclquestions:downloadresponses']         = 'Download responses in a CSV file';
$string['sliclquestions:editquestions']             = 'Create and edit questionnaire questions';
$string['sliclquestions:manage']                    = 'Create and edit questionnaires';
//$string['sliclquestions:message']                   = 'Send message to non-respondents';
$string['sliclquestions:preview']                   = 'Preview questionnaires';
$string['sliclquestions:printblank']                = 'Print blank questionnaire';
//$string['sliclquestions:readallresponseanytime']    = 'Read all responses any time';
//$string['sliclquestions:readallresponses']          = 'Read response summaries, subject to open times';
//$string['sliclquestions:readownresponses']          = 'Read own responses';
...
$string['statsassessedcontent']                     = '<p>This page displays a list of the Creative Enquirers registered on the SLiCL project with the number of pupils, both male and female, they have assessed, with the number registered displayed in brackets.</p>';
$string['statsregisteredcontent']                   = '<p>This page displays a list of the Creative Enquirers registered on the SLiCL project with the number of pupils, both male and female, they have registered on the project.</p>';
...
//$string['autonumbering_help']                       = 'Automatic numbering of questions and pages. You might want to disable automatic numbering for questionnaires with conditional branching.';
...
//$string['createcontent_link']                       = 'mod/sliclquestions/mod#Content_Options';
...
//$string['date_link']                                = 'mod/sliclquestions/questions#Date';
...
//$string['dependquestion_help']                      = 'You can select a parent question and a choice option for this question. A child question will only be displayed to the student if its parent question and parent choice have been previously selected.';
//$string['dependquestion_link']                      = 'mod/sliclquestions/questions#Parent_Question';
//$string['displaymethod']                            = 'Display method not defined for question.';
//$string['download']                                 = 'Download';
//$string['downloadtextformat']                       = 'Download in text format';
//$string['downloadtextformat_help']                  = 'This feature enables you to save all the responses of a questionnaire to a text file (CSV). This file can then be imported into a spreadsheet (e.g. MS Excel or Open Office Calc) or a statistical package for further processing the data.';
//$string['downloadtextformat_link']                  = 'mod/sliclquestions/report#Download_in_text_format';
//$string['dropdown']                                 = 'Dropdown Box';
//$string['dropdown_help']                            = 'There is no real advantage to using the Dropdown Box over using the Radio Buttons except perhaps for longish lists of options, to save screen space.';
//$string['dropdown_link']                            = 'mod/sliclquestions/questions#Dropdown_Box';
//
//$string['edit']                                     = 'Edit';
//$string['editingquestionnaire']                     = 'Editing SLiCL Questions Settings';
...
//$string['essaybox_help']                            = 'This question will display a plain text box with x Textarea columns (or area width) and y Textarea rows (number of text lines). If you leave both x and y to their default 0 value (or if you set it to 0), then moodle\'s HTML editor will be displayed with standard height and width (if available in the course/user context & user profile).';
//
//$string['feedback']                                 = 'Feedback';
//$string['feedback_help']                            = 'Feedback Help';
//$string['feedback_link']                            = 'mod/sliclquestion/personality_test#Editing_Questionnaire_Feedback_Messages';
//$string['feedbackaddmorefeedbacks']                 = 'Add {no} more feedback fields';
//$string['feedbackbysection']                        = 'Sections Feedback';
//$string['feedbackeditingglobal']                    = 'Editing SLiCL Questionnaire Global Feedback';
//$string['feedbackeditingsections']                  = 'Editing SLiCL Questionnaire Feedback Sections';
...
//$string['feedbackoptions_help']                     = 'Feedback options are available if your questionnaire contains the following question types and question settings: Radio buttons; Dropdown box or Rate. Those questions must be set as Required, their Question Name field must NOT be empty and the Possible answers choices must contain a value.';
//$string['feedbackoptions_link']                     = 'mod/sliclquestions/personality_test';
...
//$string['feedbacksectionsselect_link']              = 'mod/sliclquestios/personality_test#Editing_Questionnaire_Feedback_Sections_2';
...
//$string['kindofratescale_link']                     = 'mod/sliclquestions/questions#Type_of_rate_scale';
//
...
//$string['managequestions_link']                     = 'mod/sliclquestions/questions#Manage_questions';
//$string['maxdigitsallowed']                         = 'Max. digits allowed';
//$string['maxdigitsallowed_help']                    = 'By using the Max. digits allowed and Nb of decimal digits parameters you can specify the length and number of decimal places required.';
...
//$string['minforcedresponses_help']                  = 'Use these parameters to force respondent to tick a minimum of **Min.** boxes and a maximum of **Max.** check boxes. To force an exact number of check boxes to be ticked, set **Min.** and **Max.** to the same value. If only a min or a max value is desired, just leave the other value to its default **0** value. If you set **Min.** or **Max.** to values other than their default **0** value, a warning message will be displayed if respondent does not comply with your requirements. Obviously you should make any requirements clear to the respondent either in the general instructions of your Questionnaire or in the text of relevant questions.';
...
//$string['questiontypes_link']                       = 'mod/sliclquestions/questions#Question_Types';
//
...
//$string['radiobuttons_link']                        = 'mod/sliclquestions/questions#Radio_Buttons';
//$string['rank']                                     = 'Rank';
//$string['ratescale']                                = 'Rate (scale 1..5)';
//$string['ratescale_help']                           = 'See the Moodle Documentation below';
//$string['ratescale_link']                           = 'mod/sliclquestions/questions#Rate_.28scale_1..5.29';
...
//$string['realm_link']                               = 'mod/sliclquestions/qsettings#Questionnaire_Type';
