...
class sliclquestions_assessment_form extends moodleform
{
    public function definition()
    {
        ...
        $mform->addElement('html', html_writer::div('h4', get_string('kpi2', 'sliclquestions'), array('class' => 'kpi-2 slicl-legend')));
        $mform->addElement('html', html_writer::div('h4', get_string('kpi3', 'sliclquestions'), array('class' => 'kpi-3 slicl-legend')));
        $mform->addElement('html', html_writer::div('h4', get_string('kpi4', 'sliclquestions'), array('class' => 'kpi-4 slicl-legend')));
