...
class sliclquestions_assessment_form extends moodleform
{
    public function definition()
    {
        ...
        $mform->addElement('html', html_writer::div(get_string('kpi1', 'sliclquestions'), 'kpi-1 slicl-legend'));
        $mform->addElement('html', html_writer::div(get_string('kpi2', 'sliclquestions'), 'kpi-2 slicl-legend'));
        $mform->addElement('html', html_writer::div(get_string('kpi3', 'sliclquestions'), 'kpi-3 slicl-legend'));
        $mform->addElement('html', html_writer::div(get_string('kpi4', 'sliclquestions'), 'kpi-4 slicl-legend'));
