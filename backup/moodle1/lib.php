...
class moodle1_mod_sliclquestions_handler extends moodle1_mod_handler
{
    /**
    ...
    {
        return array(new convert_path('sliclquestions',
                                      '/MOODLE_BACKUP/COURSE/MODULES/MOD/SLICLQUESTIONS',
                                      array('renamefields' => array('summary' => 'intro'),
                                            'newfields'    => array('introformat' => 0))),
                     new convert_path('survey',
                                      '/MOODLE_BACKUP/COURSE/MODULES/MOD/SLICLQUESTIONS/SURVEY'),
                     new convert_path('question',
                                      '/MOODLE_BACKUP/COURSE/MODULES/MOD/SLICLQUESTIONS/SURVEY/QUESTION'),
                     new convert_path('question_choice',
                                      '/MOODLE_BACKUP/COURSE/MODULES/MOD/SLICLQUESTIONS/SURVEY/QUESTION/QUESTION_CHOICE'));
    }

    /**
     * This is executed every time we have one /MOODLE_BACKUP/COURSE/MODULES/MOD/SLICLQUESTIONS
     * data available
     */
    public function process_sliclquestions($data)
    {
        ...
        $this->open_xml_writer("activities/sliclquestions_{$moduleid}/sliclquestions.xml");
        $this->xmlwriter->begin_tag('activity', array('id' => $instanceid, 'moduleid' => $moduleid,
            'modulename' => 'sliclquestions', 'contextid' => $contextid));
        $this->xmlwriter->begin_tag('sliclquestions', array('id' => $instanceid));
     ...
     */
    public function on_sliclquestions_end()
    {
        // Close questionnaire.xml.
        $this->xmlwriter->end_tag('surveys');
        $this->xmlwriter->end_tag('sliclquestions');
        $this->xmlwriter->end_tag('activity');
        $this->close_xml_writer();
    }

    /**
     * This is executed every time we have one /MOODLE_BACKUP/COURSE/MODULES/MOD/SLICLQUESTIONS/SURVEY
     * data available
     */
