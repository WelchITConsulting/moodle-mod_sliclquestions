...
function draw_chart($feedbacktype, $charttype=null, $labels, $score=null,
                    $allscore=null, $globallabel=null, $groupname, $allresponses)
{
    ...
    $charttitlesize = 10;
    $charttitlesize2 = 10;
    if ($PAGE->pagetype == 'mod-sliclquestions-myreport') {
        $charttitle = get_string('yourresponse', 'sliclquestions');
    } else {
        $charttitle = get_string('thisresponse', 'sliclquestions');
    }
